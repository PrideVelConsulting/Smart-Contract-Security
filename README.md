...
| 5    | [Use separate checks in require() to save gas](https://github.com/PrideVelConsulting/Smart-Contract-Security/blob/main/Checklist/Reference%20Files/5.md) | GAS      | ALL              | GENERIC                |   |
